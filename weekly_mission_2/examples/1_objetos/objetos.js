...
console.log(myObjetc, objetovacio)
...
const myPet = {
  name: "Woopa",
  sayHelloToMyPet: function(titulo){
    console.log(`${this.name} say's hello to ${titulo}`)
  }
}

console.log("Ejemplo 5: Objeto con método que recibe parámetros")
myPet.sayHelloToMyPet("Tulio Herdero")